...
export default function Home() {
  return (
    <div className="w-11/12 lg:w-3/4 mx-auto selection:bg-primary selection:text-primary-foreground">
      <header>
        <div className="grid mt-5 gap-2 grid-cols-1 md:grid-cols-[1fr_2fr_1fr]">
